...
def _update_config(config_path: str, out_value: str, config: configparser.ConfigParser) -> None:
    ...
    with tempfile.NamedTemporaryFile(mode='w', delete=False, dir=os.path.dirname(config_path)) as tmp:
