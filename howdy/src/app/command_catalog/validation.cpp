...
namespace howdy::native::command_catalog_internal {
	...
	auto validate_commands(std::span<const CommandDescriptor> commands, bool require_complete)
	...
	auto validate_global_options(std::span<const GlobalOptionDescriptor> options,
...
namespace howdy::native {
	...
	auto validate_command_catalog(std::span<const CommandDescriptor> commands,
	                              bool require_complete) -> std::optional<std::string> {
		return command_catalog_internal::validate_commands(commands, require_complete);
	}

	auto validate_global_option_catalog(std::span<const GlobalOptionDescriptor> options,
	                                    bool require_complete) -> std::optional<std::string> {
		return command_catalog_internal::validate_global_options(options, require_complete);
	}
